...
public class DeclineCommand extends SubCommand {
    ...
    public boolean run(User user, String[] args) {
        ...
        String displayName = requester.getRank().getPrefix() + "&l &f" + requester.getRank().getPrefix() + requester.getNickname();
        player.sendMessage(ChatUtil.sendColor("&b▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂"));
        player.sendMessage(ChatUtil.sendColor("&aYou have &cdecline &afriend request with &f" + displayName + "&a."));
        player.sendMessage(ChatUtil.sendColor("&b▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂"));
        return true;
    }
